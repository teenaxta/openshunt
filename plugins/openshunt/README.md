...
The source repository includes VALIDATION.md, evals/native-recorded-results.json and evals/ACCEPTANCE.md. Opt-in live tests and benchmarks consume account usage. The macOS/Linux CI matrix is configured; local checks are not proof it has run remotely.
